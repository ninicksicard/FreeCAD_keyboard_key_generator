...
class BatchKeycapDialog(QtWidgets.QDialog):
    def __init__(self, document: App.Document) -> None:
        ...
        self.primary_offset_x_spin_box.setValue(-1.0)
        ...
        self.shift_offset_x_spin_box.setValue(1.0)
        ...
        self.shift_offset_y_spin_box.setValue(1.0)
    ...
    def update_preview_clicked(self) -> None:
        ...
        preview_shape = build_keycap_with_legend_shape(
            ...
            blank_key= blank_key,
            primary_label=generate_configuration.preview_label,
            shift_label="",
        )
