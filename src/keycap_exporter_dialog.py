...
class BatchKeycapDialog(QtWidgets.QDialog):
    def __init__(self, document: App.Document) -> None:
        ...
        self.normal_selector = QtWidgets.QComboBox()
        for normal_label in NORMAL_DIRECTIONS.keys():
            self.normal_selector.addItem(normal_label)
        ...
        form_layout.addRow("Legend normal:", self.normal_selector)
    ...
    def get_configuration_for_preview(self) -> ExportConfiguration:
        ...
        return ExportConfiguration(
            ...
            normal_choice_label=self.normal_selector.currentText().strip(),
            font_path=font_path,
